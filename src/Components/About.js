...
export default function About() {
    ...
    let toggleChange = () => {
        if(Style.color === "#1F2128"){
            setStyle({
                color : "#ECECED",
                backgroundColor : "#1F2128",
                border: "1px groove #ECECED"
            })
    ...
    return (
        <>
        <div className="container my-1 py-2" style={Style}>
        ...
        <div className="container my-3">
            <button onClick={toggleChange} type="button" className={btnclass}>{Text}</button>
        </div>
        </>
    )
}
